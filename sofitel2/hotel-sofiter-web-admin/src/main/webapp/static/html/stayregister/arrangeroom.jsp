    ...
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
      ...
      <div class="span12">
	   ...
	   <div class="span12" style="margin-top:-17px;">
        <div class="row-fluid">
            <%--  onclick="allroomfunction()" --%>
          <button id="allRoom" class="btn btn-info btn-small" type="button">所有房间</button>
 ...
 <script type="text/javascript">
   ...
   var guestRoomLevelID=0;
    ...
    function deletefunction(){
     ...
     parent.document.getElementById('Mainid').src='/static/StayRegister/tolist.do?LvKeLeiXingId='+LvKeLeiXingId;
   }
   ...
   function tijiao(){
      ...
      var LvKeLeiXingId=document.getElementById("LvKeLeiXingId").value;
      form1.action="/static/StayRegister/arrangeroom.do?LvKeLeiXingId="+LvKeLeiXingId;
      form1.submit();
   }
