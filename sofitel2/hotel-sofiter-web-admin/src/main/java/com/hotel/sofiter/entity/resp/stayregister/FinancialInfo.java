...
/*-------------------------------------------- 消费明细 start ------------------------------------------------------------*/			
	...
	/*登记时间字符串话*/
	@ApiModelProperty("登记时间字符串")
	private String registerTimeStr;
	/*时间字符串话*/
	@ApiModelProperty("换房时间字符串")
	private String changRoomTimeStr;
	/*时间字符串话*/
	@ApiModelProperty("结账时间字符串")
	private String payTimeStr;

	public String getChangRoomTimeStr() {
		if (changRoomTime!=null){
			changRoomTimeStr = changRoomTime.toString();
		}
		return changRoomTimeStr;
	}

	public void setChangRoomTimeStr(String changRoomTimeStr) {
		this.changRoomTimeStr = changRoomTimeStr;
	}

	public String getPayTimeStr() {
		if (payTime != null){
			payTimeStr = payTime.toString();
		}
		return payTimeStr;
	}
	...
	public String getRegisterTimeStr() {
		registerTimeStr = registerTime.toString();
